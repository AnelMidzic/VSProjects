...
namespace WebProdavnica.Models
{
    public partial class ProdavnicaContext : DbContext
    {
        ...
        public virtual DbSet<Kupac> Kupaci { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kupac>(entity =>
            {
                ...
                entity.Property(e => e.Drzava).HasDefaultValueSql("('Bihac')");

                entity.Property(e => e.Grad).HasDefaultValueSql("('Bosna i Hercegovina')");
            });
