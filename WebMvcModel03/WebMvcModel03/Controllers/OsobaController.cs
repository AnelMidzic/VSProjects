...
namespace WebMvcModel03.Controllers
{
    public class OsobaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OsobaId,Ime,Prezime,Telefon,DatumRodjenja")] Osoba osoba)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OsobaId,Ime,Prezime,Telefon,DatumRodjenja")] Osoba osoba)
        {
            if (id != osoba.OsobaId)
            {
                return NotFound();
